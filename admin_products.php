...
if (isset($_POST['add_product'])) {
   ...
   $quantity = filter_var($quantity, FILTER_SANITIZE_NUMBER_INT); // Sanitize quantity input
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" min="0" name="quantity" class="box" required placeholder="Enter product quantity (kg)">
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="quantity">Available: <?= $fetch_products['quantity']; ?> kg</div>
      <div class="flex-btn">
