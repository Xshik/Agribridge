...
if (isset($_POST['add_to_cart'])) {
   ...
   if ($product['quantity'] >= $p_qty) {
      ...
      if ($check_cart_numbers->rowCount() > 0) {
         ...
         // Decrease the product quantity after adding to cart
         $new_quantity = $product['quantity'] - $p_qty;
         $update_product_quantity = $conn->prepare("UPDATE `products` SET quantity = ? WHERE id = ?");
         $update_product_quantity->execute([$new_quantity, $pid]);
...
<body>
   ...
   <div class="home-bg">
      ...
      <section class="home">
         ...
         <div class="content">
            <span>Go Local, Go Organic</span>
            <h3>Organic Vegetables and Fruits Direct from the Local Farm</h3>
